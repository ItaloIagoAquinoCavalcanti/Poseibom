...
const CompraTilpiaFresca = () => {
  ...
  return (
    <View style={styles.compratilpiafresca}>
      <View style={[styles.barrainferior, styles.barrainferiorLayout]}>
        ...
        <Text style={[styles.r1899, styles.totalClr]}>R$ {valorTotal}</Text>
      </View>
      ...
      <Pressable
        ...
        onPress={() => navigation.navigate("CartoTilpiaFresca")}
      >
      ...
      <View style={[styles.especificaes, styles.especificaesLayout]}>
        ...
        <Text style={[styles.x1, styles.x1Typo]}>x {quantidade}</Text>
        <Text style={[styles.r18991, styles.x1Typo]}>R$ {valorProduto}</Text>
        <Image
...
export default CompraTilpiaFresca;
