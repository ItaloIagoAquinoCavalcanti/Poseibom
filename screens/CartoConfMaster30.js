...
const CartoConfMaster30 = () => {
  const navigation = useNavigation();

  return (
    <View style={styles.cartoconfmaster30}>
      ...
      >
        <Image
          style={styles.icon}
          contentFit="cover"
          source={require("../assets/botovoltar1.png")}
        />
      </Pressable>
...
export default CartoConfMaster30;
