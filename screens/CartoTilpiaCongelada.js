...
const CartoTilpiaCongelada = () => {
  const navigation = useNavigation();

  return (
    <View style={styles.cartotilpiacongelada}>
      <View style={[styles.barrainferior, styles.barrainferiorLayout]}>
        ...
        <Text style={[styles.r2499, styles.totalPosition]}>R$ 24,99</Text>
      </View>
      ...
      <Pressable
        ...
        onPress={() => navigation.navigate("CartoConfVisa30")}
      >
      ...
      <Pressable
        ...
        onPress={() => navigation.navigate("CartoConfHiper30")}
      >
      ...
      <Pressable
        ...
        onPress={() => navigation.navigate("CartoConfNubank30")}
      >
      ...
      <Pressable
        ...
        onPress={() => navigation.navigate("CartoConfMaster30")}
      >
      ...
      <Pressable
        ...
        onPress={() => navigation.navigate("TelaNovoCartoNoPgamento30")}
      >
...
export default CartoTilpiaCongelada;
