...
const PixTilpiaFresca = () => {
  ...
  async function handleComprar() {
    ...
    navigation.navigate("QrCodeTilpiaFresca")
  }

  return (
    <View style={styles.pixtilpiafresca}>
      <View style={[styles.barrainferior, styles.barrainferiorLayout]}>
        ...
        <Text style={styles.r1899}>R$ 18,99</Text>
      </View>
      <Pressable
...
export default PixTilpiaFresca;
