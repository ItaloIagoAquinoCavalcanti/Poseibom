...
const CartoConfMaster20 = () => {
  const navigation = useNavigation();

  return (
    <View style={styles.cartoconfmaster20}>
      <View style={[styles.barrainferior, styles.barrainferiorLayout]}>
        ...
        <Text style={[styles.r1199, styles.totalPosition]}>R$ 11,99</Text>
      </View>
      <Pressable
      ...
      <Pressable
        ...
        onPress={() => navigation.navigate("CartoConfVisa20")}
      >
      ...
      <Pressable
        ...
        onPress={() => navigation.navigate("CartoConfHiper20")}
      >
      ...
      <Pressable
        ...
        onPress={() => navigation.navigate("CartoConfNubank20")}
      >
      ...
      <Pressable
        ...
        onPress={() => navigation.navigate("TelaNovoCartoNoPgamento")}
      >
...
export default CartoConfMaster20;
